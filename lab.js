...
//Code Here
let phoneOne = new Phone('samsung',"Galaxy S", 128, "red", 500)
let phoneTwo = new phone('Apple', 'Iphone 10 xr', 64, "blue", 900)
let phoneThree = new Phone("Nokia", "Blackberry", 64, "black", 100)
